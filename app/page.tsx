  ...
  const animes = [
    {
      title: "Naruto",
      image:
        "https://wallpapercave.com/wp/wp8849879.jpg",
    },
    {
      title: "One Piece",
      image:
        "https://wallpapercave.com/wp/wp7432294.jpg",
    },
    {
      title: "Attack on Titan",
      image:
        "https://wallpapercave.com/wp/wp6200192.jpg",
    },
  ];
...
<section className="grid grid-cols-1 md:grid-cols-3 gap-10 px-10 pb-20">
  ...
  <div className="group bg-zinc-900/80 backdrop-blur-sm rounded-3xl overflow-hidden hover:scale-105 hover:-translate-y-2 transition duration-500 shadow-2xl border border-zinc-800">
    ...
    <div className="p-5">
      ...
      <p className="text-yellow-400 mt-2">⭐ 9.8 / 10</p>
  ...
  <div className="group bg-zinc-900/80 backdrop-blur-sm rounded-3xl overflow-hidden hover:scale-105 hover:-translate-y-2 transition duration-500 shadow-2xl border border-zinc-800">
    ...
    <div className="p-5">
      ...
      <p className="text-yellow-400 mt-2">⭐ 9.7 / 10</p>
  ...
  <div className="group bg-zinc-900/80 backdrop-blur-sm rounded-3xl overflow-hidden hover:scale-105 hover:-translate-y-2 transition duration-500 shadow-2xl border border-zinc-800">
    ...
    <div className="p-5">
      ...
      <p className="text-yellow-400 mt-2">⭐ 9.9 / 10</p>
